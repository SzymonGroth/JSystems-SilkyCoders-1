...
- The project is structured such that each business domain/feature is contained within its own separate package or directory.
- This modular approach ensures that business logic is decoupled, making it easy to extract specific pieces into separate microservices or applications if needed in the future.
...
- Every AI Agent working on this project MUST maintain a `changelog.md` file in the project root.
- After each prompt/task, the agent should append a summary of changes made.
